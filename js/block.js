function Block() {
    ...
    this.gopHeight = baseObj.randomNum(150,160)
    this.upHeight = 312 - this.downHeight - this.gopHeight
    ...
    this.createBlock = function() {
        ...
        var downDiv1 = this.createDiv('url(img/up_pipe.png)', '60px')
        var downDiv2 = this.createDiv('url(img/up_mod.png)', this.downHeight + 'px')
